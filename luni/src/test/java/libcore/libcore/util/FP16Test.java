...
public class FP16Test extends TestCase {
    ...
    public void testFloor() {
        ...
        assertShortEquals((short) 0x7e01, FP16.floor((short) 0x7c01));
        assertShortEquals((short) 0x7f00, FP16.floor((short) 0x7d00));
        assertShortEquals((short) 0xfe01, FP16.floor((short) 0xfc01));
        assertShortEquals((short) 0xff00, FP16.floor((short) 0xfd00));
    }
    ...
    public void testRint() {
        ...
        // These test check whether the ceil function acheives bit level
        // compatibility with FRINTN ARM instruction
